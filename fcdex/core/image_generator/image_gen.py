...
title_font = ImageFont.truetype(str(SOURCES_PATH / "playfair-display.bold.ttf"), 165)
capacity_name_font = ImageFont.truetype(str(SOURCES_PATH / "fredoka-one.one-regular.ttf"), 97)
capacity_description_font = ImageFont.truetype(str(SOURCES_PATH / "exo-2-0.medium.otf"), 75)
stats_font = ImageFont.truetype(str(SOURCES_PATH / "Seven Segment.ttf"), 135)
credits_font = ImageFont.truetype(str(SOURCES_PATH / "arial.ttf"), 50)
